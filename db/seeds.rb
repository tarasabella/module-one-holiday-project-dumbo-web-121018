...
ben = User.create(name: "Ben", username: "b", password: "b")
...
goal3 = Goal.create(title: "Learn To Cope With Stress Through Meditation", description: "This is a description! Don't you love it?", categoryid: financial.id, userid:tara.id)
goal4 = Goal.create(title: "Learn To Cope With Stress Through Meditation", description: "This is a description! Don't you love it?", categoryid: career.id, userid:tara.id)
goal5 = Goal.create(title: "Learn To Cope With Stress Through Meditation", description: "This is a description! Don't you love it?", categoryid: educational.id, userid:tara.id)
goal6 = Goal.create(title: "Learn To Cope With Stress Through Meditation", description: "This is a description! Don't you love it?", categoryid: spiritual.id, userid:tara.id)
goal7 = Goal.create(title: "Learn To Cope With Stress Through Meditation", description: "This is a description! Don't you love it?", categoryid: travel.id, userid:tara.id)
goal8 = Goal.create(title: "Learn To Cope With Stress Through Meditation", description: "This is a description! Don't you love it?", categoryid: personalDevelopment.id, userid:tara.id)
goal9 = Goal.create(title: "Learn To Cope With Stress Through Meditation", description: "This is a description! Don't you love it?", categoryid: personalDevelopment.id, userid:tara.id)
goal10 = Goal.create(title: "Learn To Cope With Stress Through Meditation", description: "This is a description! Don't you love it?", categoryid: personalDevelopment.id, userid:tara.id)
